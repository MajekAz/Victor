...
const FindAJob: React.FC = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      message: `Candidate registration.\nSector: ${formData.sector}\nName: ${formData.name}\nEmail: ${formData.email}`,
      source: "Website Find A Job Page",
          ...
          <div className="bg-blue-600 rounded-[40px] p-12 text-white relative overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-16 relative z-10">
              ...
              <form className="bg-white p-10 rounded-3xl text-slate-900 space-y-4 shadow-2xl" onSubmit={handleRegister}>
                ...
                {status === 'error' && (
                  <div className="flex items-start space-x-3 p-4 bg-red-50 text-red-700 rounded-xl border border-red-200">
